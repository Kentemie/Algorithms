...
def mostBooked(n, meetings):
    ...
    for start_time, end_time in meetings:
        ...
        if available_rooms:
            ...
            curr_end_time, room = heappop(occupied_rooms)
            delayed_end_time = curr_end_time - start_time + end_time
            heappush(occupied_rooms, [delayed_end_time, room])
        
        booking_counts[room] += 1

    return booking_counts.index(max(booking_counts))
