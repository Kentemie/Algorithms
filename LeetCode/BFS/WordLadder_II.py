...
def BFS(beginWord, endWord, wordList):
    ...
    while queue:
        ...
        for i in range(len(word)):
            for new_word in words[word[:i] + "*" + word[i+1:]]:
                if new_word not in seen or seen[new_word] == lvl + 1:
                    adj[new_word].add(word)
...
# beginWord = "aaaaa"
# endWord = "ggggg"
# wordList = ["aaaaa","caaaa","cbaaa","daaaa","dbaaa","eaaaa","ebaaa","faaaa","fbaaa","gaaaa","gbaaa","haaaa","hbaaa","iaaaa",
